...
// ============================================================
// EcoSphere – Signup Page matching Login redesign
// ============================================================
...
export default function SignupPage() {
  ...
  const handleSignup = async (data: any) => {
    await mockSignUp(data.email, data.password, data.fullName);
      ...
      <div className="flex flex-col justify-center flex-1 bg-[#f8fafc] px-6 py-12 lg:px-20 xl:px-28">
        <div className="mx-auto w-full max-w-sm flex flex-col items-center">
          ...
          <div className="w-full mb-6">
            ...
            <p className="text-slate-400 text-sm mt-1">Join your organization on EcoSphere</p>
          </div>

          {/* Form Card Container */}
          <div className="w-full bg-white rounded-2xl border border-slate-100 shadow-[0_10px_35px_rgba(0,0,0,0.03)] p-8">
            <SignupForm onSubmit={handleSignup} onNavigate={handleNavigate} />
          </div>
